...
Use AI-powered dialogue practice to move from passive understanding to active expression.
...
DictoGo is for English learners who:

- Can read or listen a little, but still struggle to speak
- Want to learn English through real context
- Need sentence-level explanations instead of word-by-word lookup
- Want vocabulary review connected to real content
- Want to collect useful sentences for repeated listening and speaking practice
- Prefer consistent daily practice over memorizing long word lists
- Want a clearer path from input to output

## Visit DictoGo

- Global: https://dictogo.app
- Mainland China: https://dictogo.cn

## About This Repository

This public repository hosts DictoGo product information, public documentation, links, and feedback entry points.

The DictoGo app itself is not open source in this repository.

## Feedback

If you have feedback, feature ideas, or questions, please open an issue in this repository.
